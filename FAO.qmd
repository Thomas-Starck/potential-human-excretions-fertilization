...
Food availability for 2010-2021. Data downloaded on FAOSTAT webpage Inputs -> [Availability](https://www.fao.org/faostat/en/#data/SUA){target="_blank"}, based on supply utilization accounts. We load and prepare the data.
...
Food balances for 2010-2021 and 1961-2010. Data downloaded on FAOSTAT webpage Inputs -> [Food balances (2010-)](https://www.fao.org/faostat/en/#data/FBS){target="_blank"} and [Food balances (-2013)](https://www.fao.org/faostat/en/#data/FBSH){target="_blank"}, based on supply utilization accounts. We load and prepare the data. One element reported in these food balances is the supply per capita.
